...
ENABLE_FAIL_ARTIFACTS = get_env('ENABLE_FAIL_ARTIFACTS', True, bool)
FAIL_ARTIFACT_RETENTION_DAYS = get_env('FAIL_ARTIFACT_RETENTION_DAYS', 14, int)
FAIL_ARTIFACT_MAX_BYTES = get_env('FAIL_ARTIFACT_MAX_BYTES', 1024 * 1024 * 1024, int)
FAIL_ARTIFACT_TARGET_BYTES = get_env('FAIL_ARTIFACT_TARGET_BYTES', 800 * 1024 * 1024, int)
FAIL_ARTIFACT_SCREENSHOT_THROTTLE_SECONDS = get_env('FAIL_ARTIFACT_SCREENSHOT_THROTTLE_SECONDS', 30 * 60, int)
