...
from src.utils.fail_artifacts import maybe_cleanup_fail_artifacts
    ...
    try:
        ...
        for g, crawler in crawlers.items():
            try:
                ...
                pass
        try:
            maybe_cleanup_fail_artifacts(force=True)
        except Exception as cleanup_error:
            log(f"Không thể cleanup fail artifacts sau job multi-room: {cleanup_error}", level=logging.WARNING)
